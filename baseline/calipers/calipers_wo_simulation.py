...
sys.path.insert(
    0,
    os.path.join(arch_explorer_root)
)
sys.path.insert(
    0,
    os.path.join(arch_explorer_root, "funcs")
)
sys.path.insert(
    0,
    os.path.join(arch_explorer_root, "utils")
)
import re
import random
import argparse
...
from utils import if_exist, info, remove, parse_args, mkdir, get_configs, \
...
ISA                      RISC-V
Core                     OoO
Branch_Predictor         StatisticalB
Branch_Predictor_Config  90:1 # accuracy:prediction_cycles
I_Cache                  StatisticalC
I_Cache_Config           98:2:10:98:2:10 # load_hit_rate:load_hit_cycles:load_miss_cycles:store_hit_rate:store_hit_cycles:store_miss_cycles
D_Cache                  StatisticalC
D_Cache_Config           98:2:10:98:2:10 # load_hit_rate:load_hit_cycles:load_miss_cycles:store_hit_rate:store_hit_cycles:store_miss_cycles
Instr_Buffer_Size        {}
Instr_Queue_Size         {}
Fetch_Bandwidth          {}
Dispatch_Bandwidth       {}
